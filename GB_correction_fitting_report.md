...
- **실험 비교**: σ_full ≈ 0.196 mS/cm (σ_grain 기준) vs Minnmann 0.17 mS/cm (**1.15×, 거의 일치**)
...
|---|---|---|---|
| **공식** | σ_brug × 0.026 × √A_hop × CN² × GB_d^(4/3) | 0.015 × σ_AM × φ^(3/2) × CN² × exp(π/(T/d)) | 286 × σ_ion^(3/4) × φ_AM² / CN_SE |
| **주도 인자** | Contact quality | Topology | 2상 competition |
| **CN** | CN_SE² (+) | CN_AM² (+) | CN_SE⁻¹ (**-**!) |
| **Thickness** | 간접 (GB_d 반영) | exp(π/(T/d)) | 무관 |
| **R²** | 0.93 (LOOCV 0.93) | 0.89 | 0.90 (LOOCV 0.86) |
| **Free params** | 1 | 1 | 1 |
...
*Report generated by DEM Analyzer | DEM-Native Transport Framework (Ionic + Electronic + Thermal)*
