# Computational Methods — Paper Draft (CONFIRMED)
...
Actual k-grids used:
- EOS relax: 3×3×3 (cubic), 2×2×1 (rhombo)
- Post-relax SCF: 3×3×3 (cubic), 2×2×1 (rhombo)
- NSCF: 6×6×6 / 8×8×8 (cubic), 4×4×2 (rhombo)
- Model C v2 EOS: 6×6×3 (upgraded)
- DOS/band gap results not included in paper → NSCF not mentioned in methods
